...
const Screen = lazy(() => {
  return import(
    /* webpackChunkName: "cs222rt" */ "src/pages/user/predefinedHabits/predefinedHabits"
  ).catch(() => {
...
export const LazyPredefinedHabitsScreen = ({
  navigation,
  route,
  props,
}: {
  ...
  return (
    ...
    >
      <Screen navigation={navigation} route={route} {...props} />
    </Suspense>
  );
};
