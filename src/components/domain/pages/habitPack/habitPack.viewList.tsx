...
const HabitPackViewListScreen = ({
  ...
  const viewListConfig = useViewListConfig("HabitPack", route);
  ...
  return (
    <WebFadeIn off={!fadeIn} style={style} background={true}>
      <View style={[layoutStyles.page, layoutStyles.paddingMob20, cmsStyles?.habitPackViewList, style]}>
        <ScrollView
          scrollEnabled={scrollEnabled}
          nestedScrollEnabled={true}
          style={[layoutStyles.scrollViewContainer]}
          contentContainerStyle={[layoutStyles.body, cmsStyles?.habitPackViewListContentContainerStyle ]}
          showsVerticalScrollIndicator={false}
          onScroll={scrollCallback}
          scrollEventThrottle={1000}
        >
        <Header
          title={showTitle ? text("habitPackViewList.title")[0] || "HabitPacks" : ""}
          preamble={text("habitPackViewList.preamble")[0] || ""}
          navigation={navigation}
          addNewDestination={undefined}
          
          hideGoBack={width < commonConstants.mobileBreak || hideGoBack}
          newEnabled={false}
          style={[style, cmsStyles?.habitPackViewListHeaderStyle]}
          titleStyle={cmsStyles?.habitPackViewListTitleStyle}
...
export default HabitPackViewListScreen;
