...
const MyGratitudeJournalViewListScreen = ({
  navigation,
  route,
  showTitle = true,
  // showPreamble = true,
  ...
  scrollEnabled = true,
  destination = "MyGratitudeJournalView",
  ...
  const viewListConfig = useViewListConfig("MyGratitudeJournal", route);
    ...
    <WebFadeIn off={!fadeIn} style={style} background={true}>
      <View
        style={[
          ...
          cmsStyles?.myGratitudeJournalViewList,
          style,
        ]}
      >
        <ScrollView
          ...
          contentContainerStyle={[
            layoutStyles.body,
            cmsStyles?.myGratitudeJournalViewListContentContainerStyle,
          ]}
        ...
        >
          <Header
            title={
              showTitle
                ? text("myGratitudeJournalViewList.title")[0] ||
                  "MyGratitudeJournals"
                : ""
            }
            preamble={text("myGratitudeJournalViewList.preamble")[0] || ""}
            ...
            style={[
              ...
              cmsStyles?.myGratitudeJournalViewListHeaderStyle,
            ]}
            titleStyle={cmsStyles?.myGratitudeJournalViewListTitleStyle}
          />
...
export default MyGratitudeJournalViewListScreen;
