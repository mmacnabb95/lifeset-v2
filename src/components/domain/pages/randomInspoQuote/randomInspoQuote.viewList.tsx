...
const RandomInspoQuoteViewListScreen = ({
  navigation,
  route,
  showTitle = true,
  // showPreamble = true,
  ...
  scrollEnabled = true,
  destination = "RandomInspoQuoteView",
  ...
  const viewListConfig = useViewListConfig("RandomInspoQuote", route);
  ...
  return (
    <WebFadeIn off={!fadeIn} style={style} background={true}>
      <View style={[layoutStyles.page, layoutStyles.paddingMob20, layoutStyles.parentViewList, cmsStyles?.randomInspoQuoteViewList, style]}>
        <ScrollView
          scrollEnabled={scrollEnabled}
          nestedScrollEnabled={true}
          style={[layoutStyles.scrollViewContainer]}
          contentContainerStyle={[layoutStyles.body, cmsStyles?.randomInspoQuoteViewListContentContainerStyle ]}
          showsVerticalScrollIndicator={false}
          onScroll={scrollCallback}
          scrollEventThrottle={1000}
        >
        <Header
          title={showTitle ? text("randomInspoQuoteViewList.title")[0] || "RandomInspoQuotes" : ""}
          preamble={text("randomInspoQuoteViewList.preamble")[0] || ""}
          navigation={navigation}
          addNewDestination={undefined}
          
          hideGoBack={width < commonConstants.mobileBreak || hideGoBack}
          newEnabled={false}
          style={[style, layoutStyles.viewListHeaderStyle, cmsStyles?.randomInspoQuoteViewListHeaderStyle]}
          titleStyle={cmsStyles?.randomInspoQuoteViewListTitleStyle}
...
export default RandomInspoQuoteViewListScreen;
