...
const BenefitViewListScreen = ({
  ...
  const viewListConfig = useViewListConfig("Benefit", route);
  ...
  return (
    <WebFadeIn off={!fadeIn} style={style} background={true}>
      <View style={[layoutStyles.page, layoutStyles.paddingMob20, cmsStyles?.benefitViewList, style]}>
        <ScrollView
          scrollEnabled={scrollEnabled}
          nestedScrollEnabled={true}
          style={[layoutStyles.scrollViewContainer]}
          contentContainerStyle={[layoutStyles.body, cmsStyles?.benefitViewListContentContainerStyle ]}
          showsVerticalScrollIndicator={false}
          onScroll={scrollCallback}
          scrollEventThrottle={1000}
        >
        <Header
          title={showTitle ? text("benefitViewList.title")[0] || "Benefits" : ""}
          preamble={text("benefitViewList.preamble")[0] || ""}
          navigation={navigation}
          addNewDestination={undefined}
          
          hideGoBack={width < commonConstants.mobileBreak || hideGoBack}
          newEnabled={false}
          style={[style, cmsStyles?.benefitViewListHeaderStyle]}
          titleStyle={cmsStyles?.benefitViewListTitleStyle}
        ...
        <ListBody
          ...
          viewNavItem={"ResourceEditNavOptionLarge"} 
...
export default BenefitViewListScreen;
