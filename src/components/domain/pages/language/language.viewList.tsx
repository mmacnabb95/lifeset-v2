...
import { clearLanguageItems } from "src/redux/domain/features/language/collection-slice";
// import { deleteLanguage, updateLanguage } from "src/redux/domain/features/language/item-slice";
import { Language } from "../../../../../../types/domain/flat-types";
import { useLanguageCollection } from "src/redux/domain/features/language/useLanguageCollection";
import { initialLoadSize, rootLanguage } from "src/utils";
import { useLanguagesSearchCollection } from "src/redux/domain/features/language/useLanguageSearchCollection";
import { languagesLoading } from "src/redux/domain/features/language/collection-slice";
...
const LanguageViewListScreen = ({
  ...
  const viewListConfig = useViewListConfig("Language", route);
  ...
  const {
    ...
    Filters,
  } = useLanguagesSearchCollection(initialLoadSize);
  ...
  const loading = useSelector(languagesLoading);
      ...
      >
        <ScrollView
          ...
          contentContainerStyle={[
            layoutStyles.body,
            cmsStyles?.languageViewListContentContainerStyle,
          ]}
        ...
        >
          <Header
            title={
              showTitle ? text("languageViewList.title")[0] || "Languages" : ""
            }
            preamble={text("languageViewList.preamble")[0] || ""}
            ...
            style={[
              ...
              cmsStyles?.languageViewListHeaderStyle,
            ]}
            titleStyle={cmsStyles?.languageViewListTitleStyle}
          />
...
export default LanguageViewListScreen;
