...
const TodoListJournalViewListScreen = ({
  navigation,
  route,
  showTitle = true,
  // showPreamble = true,
  ...
  scrollEnabled = true,
  destination = "TodoListJournalView",
  ...
  const viewListConfig = useViewListConfig("TodoListJournal", route);
    ...
    <WebFadeIn off={!fadeIn} style={style} background={true}>
      <View
        style={[
          ...
          cmsStyles?.todoListJournalViewList,
          style,
        ]}
      >
        <ScrollView
          ...
          contentContainerStyle={[
            layoutStyles.body,
            cmsStyles?.todoListJournalViewListContentContainerStyle,
          ]}
        ...
        >
          <Header
            title={
              showTitle
                ? text("todoListJournalViewList.title")[0] || "TodoListJournals"
                : ""
            }
            preamble={text("todoListJournalViewList.preamble")[0] || ""}
            ...
            style={[
              ...
              cmsStyles?.todoListJournalViewListHeaderStyle,
            ]}
            titleStyle={cmsStyles?.todoListJournalViewListTitleStyle}
          />
...
export default TodoListJournalViewListScreen;
