...
const WorkoutDayExerciseViewListScreen = ({
  navigation,
  route,
  showTitle = true,
  // showPreamble = true,
  ...
  scrollEnabled = true,
  destination = "WorkoutDayExerciseView",
  ...
  const viewListConfig = useViewListConfig("WorkoutDayExercise", route);
  ...
  return (
    <WebFadeIn off={!fadeIn} style={style} background={true}>
      <View style={[layoutStyles.page, layoutStyles.paddingMob20, cmsStyles?.workoutDayExerciseViewList, style]}>
        <ScrollView
          scrollEnabled={scrollEnabled}
          nestedScrollEnabled={true}
          style={[layoutStyles.scrollViewContainer]}
          contentContainerStyle={[layoutStyles.body, cmsStyles?.workoutDayExerciseViewListContentContainerStyle ]}
          showsVerticalScrollIndicator={false}
          onScroll={scrollCallback}
          scrollEventThrottle={1000}
        >
        <Header
          title={showTitle ? text("workoutDayExerciseViewList.title")[0] || "WorkoutDayExercises" : ""}
          preamble={text("workoutDayExerciseViewList.preamble")[0] || ""}
          navigation={navigation}
          addNewDestination={undefined}
          
          hideGoBack={width < commonConstants.mobileBreak || hideGoBack}
          newEnabled={false}
          style={[style, cmsStyles?.workoutDayExerciseViewListHeaderStyle]}
          titleStyle={cmsStyles?.workoutDayExerciseViewListTitleStyle}
...
export default WorkoutDayExerciseViewListScreen;
