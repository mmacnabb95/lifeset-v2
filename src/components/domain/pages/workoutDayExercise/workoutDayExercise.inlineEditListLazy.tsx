...
const Screen = lazy(() => {
  return import(
    /* webpackChunkName: "cs222rt" */ "src/components/domain/pages/workoutDayExercise/workoutDayExercise.inlineEditList"
  ).catch(() => {
...
export const LazyWorkoutDayExerciseInlineEditListScreen = ({
  navigation,
  route,
  ...rest
}: {
