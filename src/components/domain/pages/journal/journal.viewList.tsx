...
const JournalViewListScreen = ({
  ...
  const viewListConfig = useViewListConfig("Journal", route);
      ...
      >
        <ScrollView
          ...
          contentContainerStyle={[
            layoutStyles.body,
            cmsStyles?.journalViewListContentContainerStyle,
          ]}
        ...
        >
          <Header
            title={
              showTitle ? text("journalViewList.title")[0] || "Journals" : ""
            }
            preamble={text("journalViewList.preamble")[0] || ""}
            ...
            style={[
              ...
              cmsStyles?.journalViewListHeaderStyle,
            ]}
            titleStyle={cmsStyles?.journalViewListTitleStyle}
          />
...
export default JournalViewListScreen;
