...
// import { deleteUserHabitPackUse, updateUserHabitPackUse } from "src/redux/domain/features/userHabitPackUse/item-slice";
...
import { useUserHabitPackUsesSearchCollection } from "src/redux/domain/features/userHabitPackUse/useUserHabitPackUseSearchCollection";
import { userHabitPackUsesLoading } from "src/redux/domain/features/userHabitPackUse/collection-slice";
...
const UserHabitPackUseViewListScreen = ({
  navigation,
  route,
  showTitle = true,
  // showPreamble = true,
  ...
  scrollEnabled = true,
  destination = "UserHabitPackUseView",
  ...
  const viewListConfig = useViewListConfig("UserHabitPackUse", route);
  ...
  const {
    loadMore,
    loadUserHabitPackUses,
    basicParams,
    searchResult: userHabitPackUses,
    Filters,
  } = useUserHabitPackUsesSearchCollection(userId, initialLoadSize);
  ...
  const loading = useSelector(userHabitPackUsesLoading);
    ...
    <WebFadeIn off={!fadeIn} style={style} background={true}>
      <View
        style={[
          ...
          cmsStyles?.userHabitPackUseViewList,
          style,
        ]}
      >
        <ScrollView
          ...
          contentContainerStyle={[
            layoutStyles.body,
            cmsStyles?.userHabitPackUseViewListContentContainerStyle,
          ]}
        ...
        >
          <Header
            title={
              showTitle
                ? text("userHabitPackUseViewList.title")[0] ||
                  "UserHabitPackUses"
                : ""
            }
            preamble={text("userHabitPackUseViewList.preamble")[0] || ""}
            ...
            style={[
              ...
              cmsStyles?.userHabitPackUseViewListHeaderStyle,
            ]}
            titleStyle={cmsStyles?.userHabitPackUseViewListTitleStyle}
          />
          ...
          <ListBody
            ...
            loadMore={loadMore}
            doLoad={loadUserHabitPackUses}
            destination={destination}
            orderBy={["Order"]}
            paramKey="userHabitPackUseId"
...
export default UserHabitPackUseViewListScreen;
