...
const CheckInJournalEditListScreen = ({
  navigation,
  route,
  showTitle = true,
  // showPreamble = true,
  ...
  scrollEnabled = true,
  destination = "CheckInJournalEdit",
}: {
  navigation: any;
  route?: any;
  showTitle?: boolean;
  ...
  const editListConfig = useEditListConfig("CheckInJournal", route);
    ...
    <WebFadeIn off={!fadeIn} style={style} background={true}>
      <View
        style={[
          ...
          cmsStyles?.checkInJournalEditList,
          style,
        ]}
      >
        <ScrollView
          ...
          contentContainerStyle={[
            layoutStyles.body,
            cmsStyles?.checkInJournalEditListContentContainerStyle,
          ]}
        ...
        >
          <Header
            title={
              showTitle
                ? text("checkInJournalEditList.title")[0] || "Check in journals"
                : ""
            }
            preamble={text("checkInJournalEditList.preamble")[0] || ""}
        ...
        {!route.params?.viewOnly && newPosition === "bottom" && (
          <AddNew
            destinationScreen={
              route.params?.viewOnly ? "" : "CheckInJournalEdit"
            }
            params={{ checkInJournalId: "new" }}
...
export default CheckInJournalEditListScreen;
