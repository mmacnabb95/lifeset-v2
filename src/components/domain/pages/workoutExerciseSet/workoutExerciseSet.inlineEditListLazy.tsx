...
const Screen = lazy(() => {
  return import(
    /* webpackChunkName: "cs222rt" */ "src/components/domain/pages/workoutExerciseSet/workoutExerciseSet.inlineEditList"
  ).catch(() => {
...
export const LazyWorkoutExerciseSetInlineEditListScreen = ({
  navigation,
  route,
  ...rest
}: {
