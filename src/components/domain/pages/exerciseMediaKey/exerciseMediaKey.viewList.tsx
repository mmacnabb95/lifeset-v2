...
import { clearExerciseMediaKeyItems } from "src/redux/domain/features/exerciseMediaKey/collection-slice";
// import { deleteExerciseMediaKey, updateExerciseMediaKey } from "src/redux/domain/features/exerciseMediaKey/item-slice";
import { Exercisemediakey } from "../../../../../../types/domain/flat-types";
import { useExerciseMediaKeyCollection } from "src/redux/domain/features/exerciseMediaKey/useExerciseMediaKeyCollection";
import { initialLoadSize, rootLanguage } from "src/utils";
import { useExerciseMediaKeysSearchCollection } from "src/redux/domain/features/exerciseMediaKey/useExerciseMediaKeySearchCollection";
import { exerciseMediaKeysLoading } from "src/redux/domain/features/exerciseMediaKey/collection-slice";
...
const ExerciseMediaKeyViewListScreen = ({
  navigation,
  route,
  showTitle = true,
  // showPreamble = true,
  ...
  scrollEnabled = true,
  destination = "ExerciseMediaKeyView",
  ...
  const viewListConfig = useViewListConfig("ExerciseMediaKey", route);
  ...
  const {
    loadMore,
    loadExerciseMediaKeys,
    basicParams,
    searchResult: exerciseMediaKeys,
    Filters,
  } = useExerciseMediaKeysSearchCollection(initialLoadSize);
  ...
  const loading = useSelector(exerciseMediaKeysLoading);
    ...
    <WebFadeIn off={!fadeIn} style={style} background={true}>
      <View
        style={[
          ...
          cmsStyles?.exerciseMediaKeyViewList,
          style,
        ]}
      >
        <ScrollView
          ...
          contentContainerStyle={[
            layoutStyles.body,
            cmsStyles?.exerciseMediaKeyViewListContentContainerStyle,
          ]}
        ...
        >
          <Header
            title={
              showTitle
                ? text("exerciseMediaKeyViewList.title")[0] ||
                  "ExerciseMediaKeys"
                : ""
            }
            preamble={text("exerciseMediaKeyViewList.preamble")[0] || ""}
            ...
            style={[
              ...
              cmsStyles?.exerciseMediaKeyViewListHeaderStyle,
            ]}
            titleStyle={cmsStyles?.exerciseMediaKeyViewListTitleStyle}
          />
          ...
          <ListBody
            ...
            loadMore={loadMore}
            doLoad={loadExerciseMediaKeys}
            destination={destination}
            orderBy={["Order"]}
            paramKey="exerciseMediaKeyId"
...
export default ExerciseMediaKeyViewListScreen;
