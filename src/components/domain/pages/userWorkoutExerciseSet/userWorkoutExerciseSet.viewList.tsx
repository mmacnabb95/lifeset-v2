...
const UserWorkoutExerciseSetViewListScreen = ({
  navigation,
  route,
  showTitle = true,
  // showPreamble = true,
  ...
  scrollEnabled = true,
  destination = "UserWorkoutExerciseSetView",
  ...
  const viewListConfig = useViewListConfig("UserWorkoutExerciseSet", route);
  ...
  return (
    <WebFadeIn off={!fadeIn} style={style} background={true}>
      <View style={[layoutStyles.page, layoutStyles.paddingMob20, cmsStyles?.userWorkoutExerciseSetViewList, style]}>
        <ScrollView
          scrollEnabled={scrollEnabled}
          nestedScrollEnabled={true}
          style={[layoutStyles.scrollViewContainer]}
          contentContainerStyle={[layoutStyles.body, cmsStyles?.userWorkoutExerciseSetViewListContentContainerStyle ]}
          showsVerticalScrollIndicator={false}
          onScroll={scrollCallback}
          scrollEventThrottle={1000}
        >
        <Header
          title={showTitle ? text("userWorkoutExerciseSetViewList.title")[0] || "UserWorkoutExerciseSets" : ""}
          preamble={text("userWorkoutExerciseSetViewList.preamble")[0] || ""}
          navigation={navigation}
          addNewDestination={undefined}
          
          hideGoBack={width < commonConstants.mobileBreak || hideGoBack}
          newEnabled={false}
          style={[style, cmsStyles?.userWorkoutExerciseSetViewListHeaderStyle]}
          titleStyle={cmsStyles?.userWorkoutExerciseSetViewListTitleStyle}
...
export default UserWorkoutExerciseSetViewListScreen;
