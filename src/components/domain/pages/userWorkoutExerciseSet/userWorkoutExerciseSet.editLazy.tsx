...
const Screen = lazy(() => {
  return import(
    /* webpackChunkName: "cs222rt" */ "src/components/domain/pages/userWorkoutExerciseSet/userWorkoutExerciseSet.edit"
  ).catch(() => {
...
export const LazyUserWorkoutExerciseSetEditScreen = ({
  navigation,
  route,
  ...rest
}: {
