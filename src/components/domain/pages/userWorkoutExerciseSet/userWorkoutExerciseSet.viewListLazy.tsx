...
const Screen = lazy(() => {
  return import(
    /* webpackChunkName: "cs222rt" */ "src/components/domain/pages/userWorkoutExerciseSet/userWorkoutExerciseSet.viewList"
  ).catch(() => {
...
export const LazyUserWorkoutExerciseSetViewListScreen = ({
  navigation,
  route,
  ...rest
}: {
