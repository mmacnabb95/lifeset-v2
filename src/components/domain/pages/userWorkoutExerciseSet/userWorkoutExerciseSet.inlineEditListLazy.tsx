...
const Screen = lazy(() => {
  return import(
    /* webpackChunkName: "cs222rt" */ "src/components/domain/pages/userWorkoutExerciseSet/userWorkoutExerciseSet.inlineEditList"
  ).catch(() => {
...
export const LazyUserWorkoutExerciseSetInlineEditListScreen = ({
  navigation,
  route,
  ...rest
}: {
