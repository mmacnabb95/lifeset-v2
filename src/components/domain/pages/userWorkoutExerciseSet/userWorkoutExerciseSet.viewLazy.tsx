...
const Screen = lazy(() => {
  return import(
    /* webpackChunkName: "cs222rt" */ "src/components/domain/pages/userWorkoutExerciseSet/userWorkoutExerciseSet.view"
  ).catch(() => {
...
export const LazyUserWorkoutExerciseSetViewScreen = ({
  navigation,
  route,
}: {
  navigation: any;
