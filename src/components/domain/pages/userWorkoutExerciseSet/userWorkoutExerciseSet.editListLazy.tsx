...
const Screen = lazy(() => {
  return import(
    /* webpackChunkName: "cs222rt" */ "src/components/domain/pages/userWorkoutExerciseSet/userWorkoutExerciseSet.editList"
  ).catch(() => {
...
export const LazyUserWorkoutExerciseSetEditListScreen = ({
  navigation,
  route,
  ...rest
}: {
