...
import { clearHabitPackHabitScheduleItems } from "src/redux/domain/features/habitPackHabitSchedule/collection-slice";
// import { deleteHabitPackHabitSchedule, updateHabitPackHabitSchedule } from "src/redux/domain/features/habitPackHabitSchedule/item-slice";
import { Habitpackhabitschedule } from "../../../../../../types/domain/flat-types";
import { useHabitPackHabitScheduleCollection } from "src/redux/domain/features/habitPackHabitSchedule/useHabitPackHabitScheduleCollection";
import { initialLoadSize, rootLanguage } from "src/utils";
import { useHabitPackHabitSchedulesSearchCollection } from "src/redux/domain/features/habitPackHabitSchedule/useHabitPackHabitScheduleSearchCollection";
import { habitPackHabitSchedulesLoading } from "src/redux/domain/features/habitPackHabitSchedule/collection-slice";
...
const HabitPackHabitScheduleViewListScreen = ({
  navigation,
  route,
  showTitle = true,
  // showPreamble = true,
  ...
  scrollEnabled = true,
  destination = "HabitPackHabitScheduleView",
  ...
  const viewListConfig = useViewListConfig("HabitPackHabitSchedule", route);
  ...
  const {
    loadMore,
    loadHabitPackHabitSchedules,
    basicParams,
    searchResult: habitPackHabitSchedules,
    Filters,
  } = useHabitPackHabitSchedulesSearchCollection(initialLoadSize);
  ...
  const loading = useSelector(habitPackHabitSchedulesLoading);
    ...
    <WebFadeIn off={!fadeIn} style={style} background={true}>
      <View
        style={[
          ...
          cmsStyles?.habitPackHabitScheduleViewList,
          style,
        ]}
      >
        <ScrollView
          ...
          contentContainerStyle={[
            layoutStyles.body,
            cmsStyles?.habitPackHabitScheduleViewListContentContainerStyle,
          ]}
        ...
        >
          <Header
            title={
              showTitle
                ? text("habitPackHabitScheduleViewList.title")[0] ||
                  "HabitPackHabitSchedules"
                : ""
            }
            preamble={text("habitPackHabitScheduleViewList.preamble")[0] || ""}
            ...
            style={[
              ...
              cmsStyles?.habitPackHabitScheduleViewListHeaderStyle,
            ]}
            titleStyle={cmsStyles?.habitPackHabitScheduleViewListTitleStyle}
          />
          ...
          <ListBody
            navigation={navigation}
            route={route}
            listItems={habitPackHabitSchedules}
            mode="view"
            loading={loading}
            style={style}
            ...
            loadMore={loadMore}
            doLoad={loadHabitPackHabitSchedules}
            destination={destination}
            orderBy={["Order"]}
            paramKey="habitPackHabitScheduleId"
...
export default HabitPackHabitScheduleViewListScreen;
