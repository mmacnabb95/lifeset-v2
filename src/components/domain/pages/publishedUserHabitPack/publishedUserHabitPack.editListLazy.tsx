...
const Screen = lazy(() => {
  return import(
    /* webpackChunkName: "cs222rt" */ "src/components/domain/pages/publishedUserHabitPack/publishedUserHabitPack.editList"
  ).catch(() => {
...
export const LazyPublishedUserHabitPackEditListScreen = ({
  navigation,
  route,
  ...rest
}: {
