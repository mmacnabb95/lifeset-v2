...
const Screen = lazy(() => {
  return import(
    /* webpackChunkName: "cs222rt" */ "src/components/domain/pages/publishedUserHabitPack/publishedUserHabitPack.viewList"
  ).catch(() => {
...
export const LazyPublishedUserHabitPackViewListScreen = ({
  navigation,
  route,
  ...rest
}: {
