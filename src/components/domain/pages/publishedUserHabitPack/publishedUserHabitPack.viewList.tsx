...
const PublishedUserHabitPackViewListScreen = ({
  navigation,
  route,
  showTitle = true,
  // showPreamble = true,
  ...
  scrollEnabled = true,
  destination = "PublishedUserHabitPackView",
  ...
  const viewListConfig = useViewListConfig("PublishedUserHabitPack", route);
  ...
  return (
    <WebFadeIn off={!fadeIn} style={style} background={true}>
      <View style={[layoutStyles.page, layoutStyles.paddingMob20, layoutStyles.parentViewList, cmsStyles?.publishedUserHabitPackViewList, style]}>
        <ScrollView
          scrollEnabled={scrollEnabled}
          nestedScrollEnabled={true}
          style={[layoutStyles.scrollViewContainer]}
          contentContainerStyle={[layoutStyles.body, cmsStyles?.publishedUserHabitPackViewListContentContainerStyle ]}
          showsVerticalScrollIndicator={false}
          onScroll={scrollCallback}
          scrollEventThrottle={1000}
        >
        <Header
          title={showTitle ? text("publishedUserHabitPackViewList.title")[0] || "PublishedUserHabitPacks" : ""}
          preamble={text("publishedUserHabitPackViewList.preamble")[0] || ""}
          navigation={navigation}
          addNewDestination={undefined}
          
          hideGoBack={width < commonConstants.mobileBreak || hideGoBack}
          newEnabled={false}
          style={[style, layoutStyles.viewListHeaderStyle, cmsStyles?.publishedUserHabitPackViewListHeaderStyle]}
          titleStyle={cmsStyles?.publishedUserHabitPackViewListTitleStyle}
...
export default PublishedUserHabitPackViewListScreen;
