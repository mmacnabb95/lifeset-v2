...
const Screen = lazy(() => {
  return import(
    /* webpackChunkName: "cs222rt" */ "src/components/domain/pages/publishedUserHabitPack/publishedUserHabitPack.view"
  ).catch(() => {
...
export const LazyPublishedUserHabitPackViewScreen = ({
  navigation,
  route,
}: {
  navigation: any;
