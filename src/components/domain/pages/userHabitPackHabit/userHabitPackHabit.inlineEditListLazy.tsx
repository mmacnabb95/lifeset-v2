...
const Screen = lazy(() => {
  return import(
    /* webpackChunkName: "cs222rt" */ "src/components/domain/pages/userHabitPackHabit/userHabitPackHabit.inlineEditList"
  ).catch(() => {
...
export const LazyUserHabitPackHabitInlineEditListScreen = ({
  navigation,
  route,
  ...rest
}: {
