...
import { clearSetTypeItems } from "src/redux/domain/features/setType/collection-slice";
// import { deleteSetType, updateSetType } from "src/redux/domain/features/setType/item-slice";
import { Settype } from "../../../../../../types/domain/flat-types";
import { useSetTypeCollection } from "src/redux/domain/features/setType/useSetTypeCollection";
import { initialLoadSize, rootLanguage } from "src/utils";
import { useSetTypesSearchCollection } from "src/redux/domain/features/setType/useSetTypeSearchCollection";
import { setTypesLoading } from "src/redux/domain/features/setType/collection-slice";
...
const SetTypeViewListScreen = ({
  ...
  const viewListConfig = useViewListConfig("SetType", route);
  ...
  const {
    ...
    loadSetTypes,
    basicParams,
    searchResult: setTypes,
    Filters,
  } = useSetTypesSearchCollection(initialLoadSize);
  ...
  const loading = useSelector(setTypesLoading);
      ...
      >
        <ScrollView
          ...
          contentContainerStyle={[
            layoutStyles.body,
            cmsStyles?.setTypeViewListContentContainerStyle,
          ]}
        ...
        >
          <Header
            title={
              showTitle ? text("setTypeViewList.title")[0] || "SetTypes" : ""
            }
            preamble={text("setTypeViewList.preamble")[0] || ""}
            ...
            style={[
              ...
              cmsStyles?.setTypeViewListHeaderStyle,
            ]}
            titleStyle={cmsStyles?.setTypeViewListTitleStyle}
          />
...
export default SetTypeViewListScreen;
