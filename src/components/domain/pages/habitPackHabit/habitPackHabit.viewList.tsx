...
const HabitPackHabitViewListScreen = ({
  navigation,
  route,
  showTitle = true,
  // showPreamble = true,
  ...
  scrollEnabled = true,
  destination = "HabitPackHabitView",
  ...
  const viewListConfig = useViewListConfig("HabitPackHabit", route);
  ...
  return (
    <WebFadeIn off={!fadeIn} style={style} background={true}>
      <View style={[layoutStyles.page, layoutStyles.paddingMob20, cmsStyles?.habitPackHabitViewList, style]}>
        <ScrollView
          scrollEnabled={scrollEnabled}
          nestedScrollEnabled={true}
          style={[layoutStyles.scrollViewContainer]}
          contentContainerStyle={[layoutStyles.body, cmsStyles?.habitPackHabitViewListContentContainerStyle ]}
          showsVerticalScrollIndicator={false}
          onScroll={scrollCallback}
          scrollEventThrottle={1000}
        >
        <Header
          title={showTitle ? text("habitPackHabitViewList.title")[0] || "HabitPackHabits" : ""}
          preamble={text("habitPackHabitViewList.preamble")[0] || ""}
          navigation={navigation}
          addNewDestination={undefined}
          
          hideGoBack={width < commonConstants.mobileBreak || hideGoBack}
          newEnabled={false}
          style={[style, cmsStyles?.habitPackHabitViewListHeaderStyle]}
          titleStyle={cmsStyles?.habitPackHabitViewListTitleStyle}
...
export default HabitPackHabitViewListScreen;
