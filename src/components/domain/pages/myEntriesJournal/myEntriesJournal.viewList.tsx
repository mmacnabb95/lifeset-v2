...
const MyEntriesJournalViewListScreen = ({
  navigation,
  route,
  showTitle = true,
  // showPreamble = true,
  ...
  scrollEnabled = true,
  destination = "MyEntriesJournalView",
  ...
  const viewListConfig = useViewListConfig("MyEntriesJournal", route);
    ...
    <WebFadeIn off={!fadeIn} style={style} background={true}>
      <View
        style={[
          ...
          cmsStyles?.myEntriesJournalViewList,
          style,
        ]}
      >
        <ScrollView
          ...
          contentContainerStyle={[
            layoutStyles.body,
            cmsStyles?.myEntriesJournalViewListContentContainerStyle,
          ]}
        ...
        >
          <Header
            title={
              showTitle
                ? text("myEntriesJournalViewList.title")[0] ||
                  "MyEntriesJournals"
                : ""
            }
            preamble={text("myEntriesJournalViewList.preamble")[0] || ""}
            ...
            style={[
              ...
              cmsStyles?.myEntriesJournalViewListHeaderStyle,
            ]}
            titleStyle={cmsStyles?.myEntriesJournalViewListTitleStyle}
          />
...
export default MyEntriesJournalViewListScreen;
