...
const CompanyUserViewListScreen = ({
  navigation,
  route,
  showTitle = true,
  // showPreamble = true,
  ...
  const viewListConfig = useViewListConfig("CompanyUser", route);
  ...
  return (
    <WebFadeIn off={!fadeIn} style={style} background={true}>
      <View style={[layoutStyles.page, layoutStyles.paddingMob20, cmsStyles?.companyUserViewList, style]}>
        <ScrollView
          scrollEnabled={scrollEnabled}
          nestedScrollEnabled={true}
          style={[layoutStyles.scrollViewContainer]}
          contentContainerStyle={[layoutStyles.body, cmsStyles?.companyUserViewListContentContainerStyle ]}
          showsVerticalScrollIndicator={false}
          onScroll={scrollCallback}
          scrollEventThrottle={1000}
        >
        <Header
          title={showTitle ? text("companyUserViewList.title")[0] || "CompanyUsers" : ""}
          preamble={text("companyUserViewList.preamble")[0] || ""}
          ...
          newEnabled={false}
          style={[style, cmsStyles?.companyUserViewListHeaderStyle]}
          titleStyle={cmsStyles?.companyUserViewListTitleStyle}
...
export default CompanyUserViewListScreen;
